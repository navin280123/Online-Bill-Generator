...
public class clothingInvoice {
	static ArrayList<clothProduct> acdata = new ArrayList<>();

    public static void main(String[] args) {
        System.out.println("Hello World!");
        acdata.add(new clothProduct(0, 0, 0, 0, 0, 0, 0, "sdkfh",0));
        acdata.add(new clothProduct(0, 0, 0, 0, 0, 0, 0, "sdkfjhs",0));
        acdata.add(new clothProduct(0, 0, 0, 0, 0, 0, 0, "sdkfjhs",0));
        acdata.add(new clothProduct(0, 0, 0, 0, 0, 0, 0, "sdkfjhs",0));
        acdata.add(new clothProduct(0, 0, 0, 0, 0, 0, 0, "sdkfjhs",0));
        acdata.add(new clothProduct(0, 0, 0, 0, 0, 0, 0, "sdkfjhs",0));
    ...
    public clothingInvoice() throws InvoiceException {
...
//        drawTableCellText("2", 55, 515, Color.BLACK, PDType1Font.HELVETICA, 10);
    ...
    private void populateData(ArrayList<clothProduct> Data) {
    	int height= 530;
    	for(clothProduct s: Data) {
    		try {
...
//    drawTableCellText("OIL", 100, 530, Color.BLACK, PDType1Font.HELVETICA, 10); //product name
	...
	String itemName;
	clothProduct(int sn,double tax,double mrp,double sp,double discount,double amount,double qnt,String itemName, int size){
		this.sn =sn;
		this.tax =tax;
		this.mrp=mrp;
		this.sp=sp;
